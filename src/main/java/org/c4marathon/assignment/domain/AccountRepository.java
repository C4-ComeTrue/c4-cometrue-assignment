...
public interface AccountRepository extends JpaRepository<Account, Long> {
	...
	@Query(value = """
			...
			WHERE a.accountNumber = :accountNumber AND a.balance + :money >= 0
		""")
	...
	@Query("""
			SELECT a
			FROM Account a
			WHERE a.userId = :userId AND a.isMain = true
		""")
	...
	@Query("""
		...
		""")
	List<Account> findAllByAccountNumber(@Param("accountNumbers") List<String> accountNumbers);
}
